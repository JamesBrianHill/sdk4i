...
DCL-PROC SaveLocalWebServiceInfo;
  ...
  DCL-S srv_ipv4_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
  DCL-S srv_port_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
  ...
  DCL-S uri_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
...
DCL-PROC SaveMetrics;
  ...
  DCL-S abend_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
  DCL-S success_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
  DCL-S user_id_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
  DCL-S username_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
...
DCL-PROC SaveRemoteWebServiceInfo;
  ...
  DCL-S req_head LIKE(tpl_sdk4i_logwbrt_ds.req_head);
  ...
  DCL-S query_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
  DCL-S req_method_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
  DCL-S req_head_null INT(5) INZ(C_SDK4I_NULL); // Assume NULL
  ...
  req_head = i_logwbrt_ds.req_head;
  req_head_null = NIL_IndToInt(%NULLIND(i_logwbrt_ds.req_head));
  ...
  EXEC SQL
    INSERT INTO logwbrt (logmsgt_id, protocol, rmt_fqdn, rmt_ipv4, rmt_port, rmt_api, query,
      req_method, req_head, req_body, rsp_code, rsp_head, rsp_body)
    VALUES(
      :i_id,
      :protocol :protocol_null,
