...
//
// @param REQUIRED. The number of days of EMERGENCY level messages to retain.
// @param REQUIRED. The number of days of ALERT level messages to retain.
// @param REQUIRED. The number of days of CRITICAL level messages to retain.
// @param REQUIRED. The number of days of ERROR level messages to retain.
// @param REQUIRED. The number of days of WARNING level messages to retain.
// @param REQUIRED. The number of days of NOTIFICATION level messages to retain.
// @param REQUIRED. The number of days of INFORMATIONAL level messages to retain.
// @param REQUIRED. The number of days of DEBUG level messages to retain.
// @param REQUIRED. The number of days of metric data to retain.
// @param REQUIRED. The number of days of usage data to retain.
///
// -------------------------------------------------------------------------------------------------
...
DCL-PROC PurgeLOGMETT;
  ...
  log_msg = 'Purged '+ %TRIM(%EDITC(s_diagnostics_ds.row_count: 'P')) +' rows from LOGMETT';
  LOG_LogMsg(psds_ds: log_proc: log_msg: log_cause_info_ds: log_event_info_ds: log_user_info_ds);
...
DCL-PROC PurgeLOGMSGT;
  ...
  log_event_info_ds.ll_id = C_SDK4I_LL_INF;
  log_msg = 'Purged '+ %TRIM(%EDITC(s_diagnostics_ds.row_count: 'P'))+
    ' EMERGENCY level rows from LOGMSGT and '+
    %TRIM(%EDITC(s_diagnostics_ds.db2_row_count_secondary: 'P'))+
...
DCL-PROC PurgeLOGUSET;
  ...
  log_event_info_ds.ll_id = C_SDK4I_LL_INF;
  log_msg = 'Purged '+ %TRIM(%EDITC(s_diagnostics_ds.row_count: 'P')) +' rows from LOGUSET';
  LOG_LogMsg(psds_ds: log_proc: log_msg: log_cause_info_ds: log_event_info_ds: log_user_info_ds);
  RESET log_event_info_ds;
