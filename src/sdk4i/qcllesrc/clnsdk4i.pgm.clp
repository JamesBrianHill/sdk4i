...
DCL VAR(&LIBCLN) TYPE(*CHAR) LEN(10) VALUE('HILLB1')
DCL VAR(&LIBDTA) TYPE(*CHAR) LEN(10) VALUE('HILLB1')
DCL VAR(&LIBPGM) TYPE(*CHAR) LEN(10) VALUE('HILLB2')
DCL VAR(&LIBWEB) TYPE(*CHAR) LEN(10) VALUE('HILLB2')
